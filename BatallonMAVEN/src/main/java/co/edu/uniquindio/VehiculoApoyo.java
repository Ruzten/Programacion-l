...
public class VehiculoApoyo extends Vehiculo {
    ...
    public VehiculoApoyo (String id, String modelo, int aniofabricacion, int kilometraje, EstadoOperativo estadoOperativo, int misionesCompletadas, TipoFuncion tipoFuncion) {
